...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    UpdateStudent() {
        ...
        lblcet.setBounds(50, 350, 200, 30);
        lblcet.setFont(new Font("serif", Font.BOLD, 20));
        add(lblcet);

        JLabel labelcet = new JLabel();
        labelcet.setBounds(200, 350, 150, 30);
        labelcet.setFont(new Font("Tahoma", Font.PLAIN, 18));
        add(labelcet);
        ...
        try {
            ...
            while(rs.next()) {
                ...
                labelcet.setText(rs.getString("cet_score"));
